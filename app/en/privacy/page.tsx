...
<img src="/smart-hotline-last/images/main-hero.webp" alt="Privacy Policy" className="rounded-2xl shadow-2xl w-full object-cover" style={{maxHeight:'380px', objectFit:'cover'}}/>
</div>
</div>
</div>
</section>
