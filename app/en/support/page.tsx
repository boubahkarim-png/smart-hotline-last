...
{['Multichannel', 'Organized Tickets', '< 2h Response', 'Dedicated Team'].map(b => (
...
<img src={`${basePath}/images/support-tech.webp`} alt="Customer support" loading="lazy" className="relative rounded-2xl shadow-2xl w-full object-cover" style={{maxHeight:'380px', objectFit:'cover'}}/>
