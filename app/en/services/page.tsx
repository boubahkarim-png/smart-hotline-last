...
{/* SECTION 1: LIGHT HERO - Text LEFT, Image RIGHT */}
  ...
  <p className="text-white text-lg">What we actually do for you and your business</p>
  ...
  <span className="text-white font-semibold group-hover:underline text-sm">Learn more →</span>
  </Link>
  ))}
  </div>
  </div>
  ...
  <h3 className="text-2xl font-bold text-white mb-2">Results that speak for themselves</h3>
  </div>
...
<div className="max-w-6xl mx-auto px-4">
<h2 className="text-3xl lg:text-4xl font-bold text-center mb-12 text-slate-900">What Our Clients Say</h2>
</div>
<GeoTestimonials lang="en" theme="light" layout="marquee" cardSize="sm" basePath={basePath} />
</section>
  ...
  <div className="max-w-6xl mx-auto px-4">
  <h2 className="text-3xl lg:text-4xl font-bold text-center mb-4 text-slate-900">How It Works</h2>
 ...
 <p className="text-white mb-6"> We understand the unique challenges of SMEs and offer solutions that adapt to your growth, not the other way around. </p>
...
<li className="flex items-center gap-3 text-white">
 ...
 <p className="text-white mb-6"> Our clients typically see significant improvement in their efficiency and customer satisfaction within the first few weeks. </p>
 ...
 <span>More time to focus on your core business</span>
  ...
  <h2 className="text-3xl lg:text-4xl font-bold mb-4">Ready to better manage your calls?</h2>
