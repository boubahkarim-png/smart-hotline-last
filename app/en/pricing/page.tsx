          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-1/2 animate-slide-right">
              <div className="relative float-card">
                ...
                <img src="/images/pricing-hero.png" alt="Smart Hotline Pricing" className="relative rounded-3xl shadow-2xl w-full object-cover" style={{maxHeight:'450px', objectFit:'cover'}}/>
              </div>
            </div>
          </div>
        </div>
