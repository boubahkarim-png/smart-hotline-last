...
<img src="/smart-hotline-last/images/main-hero.png" alt="Politique de Confidentialité" className="rounded-2xl shadow-2xl w-full object-cover" style={{maxHeight:'380px', objectFit:'cover'}}/>
</div>
</div>
</div>
</section>
