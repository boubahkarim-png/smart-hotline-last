...
<img src={`${basePath}/images/main-hero.webp`} alt="Conditions Générales" loading="lazy" className="rounded-2xl shadow-2xl w-full object-cover" style={{maxHeight:'380px', objectFit:'cover'}}/>
</div>
</div>
</div>
</section>
      ...
      <section className="bg-gradient-to-br from-slate-900 via-blue-950 to-blue-900 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center text-white">
          ...
          <p className="text-slate-100 mb-8">Essai gratuit de 2 semaines. Sans engagement.</p>
