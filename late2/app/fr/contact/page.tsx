export const metadata = {
  ...
  description: "Contactez Smart Hotline. Consultation gratuite sans engagement. Réponse sous 2h. Démarrez votre essai gratuit de 2 semaines. Tél: +1 (514) 819-0559.",
}
