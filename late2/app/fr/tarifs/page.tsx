export const metadata = {
  ...
  description: "Tarifs transparents pour centre d'appels PME. À partir de 15$/h. Forfaits flexibles 20h à 120h/semaine. CAD, EUR, USD, CHF acceptés. Essai gratuit 2 semaines.",
}
