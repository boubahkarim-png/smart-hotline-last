export const metadata = {
  ...
  description: "Sophie, votre agente IA vocale 24/7. Répond en français natif (Québec, France, Belgique, Suisse). Jusqu'à 70% moins cher qu'un télésecrétariat traditionnel. Essai gratuit.",
}
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="w-full lg:w-[40%]">
              <div className="relative">
                <img src="/smart-hotline-late2/images/agents-ia-hero.jpg" alt="Agent IA Sophie"
