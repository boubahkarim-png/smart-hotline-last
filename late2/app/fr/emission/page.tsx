export const metadata = {
  ...
  description: "Service d'appels sortants pour PME. Prospection téléphonique, prise de rendez-vous, leads qualifiés. Scripts optimisés. À partir de 15$/h. Essai gratuit.",
}
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="w-full lg:w-[40%]">
              <div className="relative">
                <img src="/smart-hotline-late2/images/telemarketing.jpg" alt="Conseiller appels sortants"
