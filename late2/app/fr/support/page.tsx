export const metadata = {
  ...
  description: "Support client multicanal: téléphone, email, chat, WhatsApp. Réponse sous 2h. 98% de satisfaction. Externalisez votre support client. Essai gratuit 2 semaines.",
}
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="w-full lg:w-[40%]">
              <div className="relative">
                <img src="/smart-hotline-late2/images/support-tech.jpg" alt="Support client professionnel"
