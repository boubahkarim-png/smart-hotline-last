...
export default function Page() {
  ...
  <section className="bg-gradient-to-br from-slate-900 via-orange-950 to-amber-900 text-white py-20">
    <div className="max-w-7xl mx-auto px-4">
      <div className="text-center mb-8">
        <h3 className="text-2xl font-bold text-white mb-8">Numbers That Matter</h3>
      </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-6 stagger-children">
            {[
              ...
              {q: "Is the CRM included with phone plans?", a: "Yes, basic CRM is included free with all our reception and outbound call packages."},
            ].map((faq, i) => (
  ...
  <AIAgentSchema
    ...
    description="Professional CRM integration service for Canadian SMEs. Includes SuiteCRM setup, data migration, team training, and ongoing support to centralize your leads and maximize conversions."
    capabilities={[
      "SuiteCRM setup & configuration",
      "Data migration & cleanup",
      "Team training & support",
      "Mautic email integration",
      "Zapier & API connections",
      "Custom reporting dashboards",
      "B2B/B2C list integration",
      "Click-to-call functionality"
    ]}
    responseTime="48 hour setup"
    availability="Business days support"
    languages={["English", "French"]}
    pricingModel="project-based pricing"
    startingPrice={{ amount: "50", currency: "CAD", unit: "hour" }}
  />
      <FAQSchema faqs={[
