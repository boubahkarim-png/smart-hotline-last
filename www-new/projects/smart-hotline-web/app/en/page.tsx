...
const SERVICES = [
  ...
  { Icon: HeadphonesIcon, title: 'Client Support', desc: 'Tickets, email, chat.', href: '/en/support', bg: 'bg-teal-100', color: 'text-teal-700' },
...
<img src={`${basePath}/images/main-hero.webp`} alt="Smart Hotline" width="800" height="550" className="relative rounded-3xl shadow-2xl w-full object-cover hero-image-zoom" style={{maxHeight:'550px', objectFit:'cover'}}/>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
              ...
              <div className="w-full lg:w-1/2 animate-slide-right">
                <div className="relative">
                  ...
                  <img src={`${basePath}/images/agents-ia-hero.webp`} alt="AI Agent Sophie" width="800" height="550" className="relative rounded-3xl shadow-2xl w-full object-cover hero-image-zoom" style={{maxHeight:'550px', objectFit:'cover'}}/>
                </div>
              </div>
            </div>
          </div>
