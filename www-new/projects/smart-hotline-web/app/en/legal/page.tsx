...
<img src={`${basePath}/images/main-hero.webp`} alt="Legal Notice" className="rounded-2xl shadow-2xl w-full object-cover" style={{maxHeight:'380px', objectFit:'cover'}}/>
</div>
</div>
</div>
</section>
      ...
      <section className="bg-gradient-to-br from-slate-900 via-blue-950 to-blue-900 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center text-white">
          ...
          <p className="text-white mb-8">Our team is available to answer all your questions.</p>
