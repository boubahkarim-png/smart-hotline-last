        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-6 border border-white/20">
              ...
              <p className="text-white text-sm">Français et anglais parfaits. Aucun accent, aucune hésitation.</p>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-2xl p-6 border border-white/20">
              <div className="w-12 h-12 bg-indigo-500/30 rounded-xl flex items-center justify-center mb-4">
              ...
              <p className="text-white text-sm">Protection des données conforme aux exigences québécoises.</p>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-2xl p-6 border border-white/20">
              <div className="w-12 h-12 bg-indigo-500/30 rounded-xl flex items-center justify-center mb-4">
              ...
              <p className="text-white text-sm">Même après les heures, même les week-ends. Toujours là.</p>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-2xl p-6 border border-white/20">
              <div className="w-12 h-12 bg-indigo-500/30 rounded-xl flex items-center justify-center mb-4">
              ...
              <p className="text-white text-sm">On connaît Montréal, ses quartiers, ses codes culturels.</p>
            </div>
          </div>
        </div>
      </section>
