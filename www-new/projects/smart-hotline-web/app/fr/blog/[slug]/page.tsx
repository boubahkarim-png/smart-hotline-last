...
const locale: 'fr' = 'fr' // Hardcoded for French route
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!post) {
    return { title: 'Article non trouvé | Smart Hotline' }
  }
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...
        en: post.meta.canonicalSlug ? `${baseUrl}/en/blog/${post.meta.canonicalSlug}` : undefined,
      },
    },
    twitter: {
...
export default async function BlogPostPage({ params }: PageProps) {
  ...
  const baseUrl = 'https://www.smart-hotline.com'
  const postUrl = `${baseUrl}/fr/blog/${slug}`
          ...
          {post.meta.canonicalSlug && (
            <div className="mt-12 p-6 bg-sky-50 rounded-2xl border border-sky-100">
              <p className="text-slate-700">
                ...
                <Link 
                  href={`/en/blog/${post.meta.canonicalSlug}`} 
      ...
      <section className="bg-gradient-to-br from-slate-900 via-sky-900 to-blue-900 py-20 lg:py-28 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-sky-200 text-lg mb-12 max-w-2xl mx-auto">
            Découvrez comment nos solutions peuvent améliorer votre entreprise.
          </p>
