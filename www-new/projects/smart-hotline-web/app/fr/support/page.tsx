...
export const metadata = {
  ...
  description: "Support client multicanal: téléphone, email, chat, WhatsApp. Réponse sous 2h. 98% de satisfaction. Externalisez votre support client.",
}
...
<h3 className="text-2xl font-bold text-white">Des résultats mesurables</h3>
    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center stagger-children">
        <div className="modern-box-dark p-8 animate-delay-100"><p className="text-4xl font-black text-white">98%</p><p className="text-teal-200 text-lg mt-1">Satisfaction client</p></div>
        <div className="modern-box-dark p-8 animate-delay-200"><p className="text-4xl font-black text-white">&lt; 2h</p><p className="text-teal-200 text-lg mt-1">Temps de réponse</p></div>
        <div className="modern-box-dark p-8 animate-delay-300"><p className="text-4xl font-black text-white">50K+</p><p className="text-teal-200 text-lg mt-1">Tickets/mois</p></div>
        <div className="modern-box-dark p-8 animate-delay-400"><p className="text-4xl font-black text-white">24/7</p><p className="text-teal-200 text-lg mt-1">Disponibilité</p></div>
      </div>
</div>
</section>
